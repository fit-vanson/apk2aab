...
<head>
    <meta charset='utf-8'/>
    <title>Giới thiệu chung về UpFile.vn</title>
    <meta name="csrf-token" content="{{ csrf_token() }}">
    <meta name='description'
          content='UpFile.vn là một sản phẩm thuộc sở hữu của Công ty TNHH UpFile. Hoạt động chính thức từ tháng 08/2012.'/>
    <meta name='keywords'
          content='Giới thiệu về UpFile.vn, Giới thiệu chung về UpFile.vn, Giới thiệu công ty UpFile.vn'/>
    <meta name='robots' content='index, follow'/>
    <meta property='og:title' content='Giới thiệu chung về UpFile.vn'/>
    ...
    <meta name='twitter:title' content='Giới thiệu về công ty UpFile.vn'/>
...
{{--          content='iiufi9dwer4aisqvp4l1mbtlb1cxc7d27dplu923qfma6xxi80zhfgl318smxo4qlbf8edssnzsjxbf2t8ddb0xn-0tx04a-twifmu0lv8k4fy4usn3nni9ksnv9x8av'/>--}}
    ...
    <link href='http://upfile.vn/view/default/css/upfile.css?1644897837' type='text/css' rel='stylesheet'/>
    <script>isLogged = false;</script>
    <script src='http://upfile.vn/view/default/js/upfile.js?1644897837'></script>
</head>
<body>
<div id='Header'><a href='{{route('home.index')}}' class='{{route('home.index')}}'></a>
    <ul>
        <li><a href='{{route('home.index')}}' title='Trang chủ'>Trang chủ</a></li>
...
<div id='Contact'>
    <div class='Wrapper'><h1>Giới thiệu về UpFile.vn</h1>
        <p>UpFile.vn l&agrave; một sản phẩm của C&ocirc;ng ty TNHH UpFile. Hoạt động ch&iacute;nh thức từ th&aacute;ng
            08/2012. Kể từ ng&agrave;y th&agrave;nh lập, UpFile.vn&nbsp;nhận được nhiều quan&nbsp;t&acirc;m từ ph&iacute;a
            cộng đồng trong v&agrave; ngo&agrave;i nước, ch&iacute;nh điều đ&oacute; đ&atilde; tạo động lực cho
            UpFile.vn kh&ocirc;ng ngừng cố gắng, ho&agrave;n thiện m&igrave;nh để phục vụ qu&yacute; kh&aacute;ch h&agrave;ng
            tốt hơn.</p>
        <p>UpFile.vn được x&acirc;y dựng tr&ecirc;n nền c&ocirc;ng nghệ điện to&aacute;n đ&aacute;m m&acirc;y (Cloud
            Computing) với hệ thống m&aacute;y chủ hiện đại của IBM, được đặt tại c&aacute;c trung t&acirc;m dữ liệu lớn
            tại Tp.HCM v&agrave; H&agrave; Nội, đạt ti&ecirc;u chuẩn quốc tế Tier 3 n&ecirc;n mang đến cho bạn một tốc
            độ vượt trội, ổn định v&agrave; tin cậy.</p>
        <p>Bắt đầu từ ng&agrave;y 01/12/2014, UpFile.vn ch&iacute;nh thức hoạt động miễn ph&iacute; 100%. Với th&agrave;nh
            vi&ecirc;n của UpFile.vn giờ đ&acirc;y bạn c&oacute; thể:</p>
        <ul>
            <li>Upload file l&ecirc;n đến 4 GB/file</li>
            <li>Thời gian lưu trữ file t&iacute;nh từ lần download cuối l&agrave; 60 ng&agrave;y</li>
            <li>Kh&ocirc;ng phải chờ đợi khi download file</li>
            <li><strong>Tốc độ download file l&ecirc;n đến 3 MB/s.</strong></li>
        </ul>
        <p><strong>Tất cả FREE!</strong></p>
        <p>UpFile.vn rất mong nhận được &yacute; kiến đ&oacute;ng g&oacute;p của bạn để ng&agrave;y c&agrave;ng ho&agrave;n
            thiện hơn, mang đến bạn một dịch vụ chia sẻ file tốt hơn! &Yacute; kiến đ&oacute;ng g&oacute;p của bạn xin
            gửi về <a href="http://hotro.upfile.vn" target="_blank"><strong>http://hotro.upfile.vn</strong></a>.</p>
        <p>Tr&acirc;n trọng,<br/><strong>UpFile.vn</strong></p></div>
    <div id='Footer'>
        <ul class='Links'>
            ...
            <li><a href='http://upfile.vn/blog/X7ziWZGihMzi/dieu-khoan-su-dung-upfile-vn.html'
                   title='Điều khoản sử dụng'>Điều khoản sử dụng</a></li>
            <li><a href='http://upfile.vn/blog/4yziWZOBWyzo/dieu-khoan-rieng-tu-upfile-vn.html'
                   title='Điều khoản riêng tư'>Điều khoản riêng tư</a></li>
            <li><a href='http://upfile.vn/contact/' title='Liên hệ'>Liên hệ</a></li>
        </ul>
    </div>
</div>
